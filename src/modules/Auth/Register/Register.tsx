        ...
        <Row gutter={[48, 10]}>
          <Col span={24}>
            ...
            <Controller
              name="email"
              control={control}
              render={({ field }) => <Input {...field} type="text" size="large" className="mt-1" placeholder="Enter your email address..." status={errors.email ? 'error' : ''} />}
            />
          ...
          <Col span={24}>
            ...
            <Controller
              name="name"
              control={control}
              render={({ field }) => <Input {...field} type="text" size="large" className="mt-1" placeholder="Enter your full name..." status={errors.name ? 'error' : ''} />}
            />
          ...
          <Col span={24}>
            ...
            <Controller
              name="phoneNumber"
              control={control}
              render={({ field }) => <Input {...field} type="text" size="large" className="mt-1" placeholder="Enter your phone number..." status={errors.phoneNumber ? 'error' : ''} />}
            />
