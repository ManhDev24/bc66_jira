  ...
  const items: MenuProps['items'] = [
    {
      key: '0',
      label: (
        <a className="no-underline" href={PATH.PROJECT}>
          View all project
        </a>
      ),
    },
    {
      key: '1',
      label: (
        <a className="no-underline" href={PATH.NEW}>
          Create project
        </a>
      ),
    },
      ...
      <header className="h-14 bg-white shadow px-4 fixed left-0 top-0 w-full z-header" style={{ zIndex: '10' }}>
        <div className="h-full flex justify-between items-center">
          <nav className="h-full flex items-center">
            ...
            <Dropdown className="ant-dropdown-trigger text-blue-700 h-8 font-medium py-1.5 hover:bg-blue-200 focus:bg-blue-200 rounded  px-3 px-1" menu={{ items }} trigger={['click']}>
            ...
            {/* btn link to users */}
            <Dropdown className="ant-dropdown-trigger text-blue-700 h-8 font-medium py-1.5 hover:bg-blue-200 focus:bg-blue-200 rounded px-3 px-1" overlay={menuItems1} trigger={['click']}>
              <a onClick={(e) => e.preventDefault()}>
                <Space>
                  User
                  <DownOutlined />
