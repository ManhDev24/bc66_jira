...
import { deleteProjectApi, getAllProject, getAllProjectCategoryAction } from '../../redux/slices/project_slices'
...
const ProjectList: React.FC = () => {
  ...
  return (
    <div className="container pb-6 pt_6">
      ...
      <div>
        <Table rowKey="id" columns={columns} dataSource={dataSource} pagination={true} loading={isLoading} />
      </div>
    </div>
  )
}
