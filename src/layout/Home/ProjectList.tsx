        ...
        return (
          <div className="flex">
            <Button
              ...
              className="mr-2"
              onClick={() => {
                // console.log(record.creator.name);

                if(record.creator.name === user.name){
                  navigate(`/projects/${record.id}/edit`)
                }
                else{
                  toast("Bạn không phải người tạo dự án nên không thể edit");
                }
              }}
            >
              Setting
                ...
                <div className="col-6">
                  <div className="flex">
                    <Button
                      ...
                      className="mr-2"
                      onClick={() => {
                        if(projectDetail.creator.name === user.name){
                          navigate(`/projects/${projectIdData}/edit`);
                        }
                        else{
                          toast("Bạn không phải người tạo nên thông thể edit");
                        }
                      }}
                    >
